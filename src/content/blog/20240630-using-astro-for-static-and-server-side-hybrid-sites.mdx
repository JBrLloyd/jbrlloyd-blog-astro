...
Astro components are written using Markdown frontmatter to fence (`---`) off server side javascript, Component Script, and the HTML + JS Expressions component, Component Template:
...
```tsx title="src/pages/index.asto"
---
