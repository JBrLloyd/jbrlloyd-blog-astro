...
Astro v1 framework was GA released June 2022 and has since made its way to v4. According to [State Of JS 2023 Meta Frameworks](https://2023.stateofjs.com/en-US/libraries/meta-frameworks/), it has grown in usage to rival Gatsby and Nuxt, which is is not as high as Next.js but a positive growth:

![img](./2023_stateofjs-meta-ui-frameworks-usage.png)

Additionally, the overall positive rating has made it 2nd to Next.js, and the focus on development experience with performance defaulted, has left it feeling flexible and easy to use:

![image](2023_stateofjs-meta-ui-frameworks-positivity.png)
...
import { defineConfig } from 'astro/config'; // [!code ++]
...
```astro title="src/pages/index.asto"
---
...
```tsx title="src/components/solid/SolidJsCounter.tsx"
...
```ts title="src/stores/countStore.ts"
...
```tsx title="src/components/react/ReactCounter.tsx"
